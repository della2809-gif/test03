...
const en = {
  ...
  heroEyebrow: "YOUR HEALTH, YOUR ASSET",
  heroTitle1: "Your health is your",
  heroTitle2: "most valuable asset.",
  heroBody:
    "AI analyzes your health data, supports daily action, and connects you with an expert coach when you need one.",
...
const ko: Record<MessageKey, string> = {
  ...
  heroTitle2: "자산입니다.",
  heroBody:
    "AI가 건강 데이터를 분석하고, 매일의 실천을 돕고, 필요한 순간에는 전문 코치가 함께합니다.",

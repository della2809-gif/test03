...
const DOMAIN_ACTIONS: Record<string, string> = {
  ...
  inflammation: "활동 뒤 충분히 쉬고 붓기와 통증 변화를 기록해보세요.",
  immune: "수면과 균형 잡힌 식사를 먼저 안정적으로 챙겨보세요.",
  hormone: "취침·기상·식사 시간을 일정하게 맞춰보세요.",
  liver: "음주와 야식 없는 날을 주 3일 이상 만들어보세요.",
  "brain-stress": "하루 10분 화면 없이 쉬는 시간을 정해보세요.",
  circulation: "매일 가볍게 숨이 찰 정도로 20분 걸어보세요.",
  "body-composition": "주 2회 근력 활동과 가벼운 관절 운동을 실천해보세요.",
  "youth-index": "단백질·채소·수분과 자외선 보호를 함께 챙겨보세요.",
  lifestyle: "기상 시간을 일정하게 맞추고 아침 회복감을 기록해보세요.",
};
